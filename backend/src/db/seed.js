...
// Names are stored WITHOUT the "Dr." title - templates and the UI add the
// title where appropriate, so it's never duplicated ("Dr. Dr. Rao").
const doctors = [
...
console.log("  Patient: patient@clinic.test");
doctors.forEach((d) => console.log(`  Doctor:  ${d.email} (${d.specialization})`));
